...
interface NewJoinFormProps {
  onBack: () => void;
  /** Called with the new join record's id once it has been created. */
...
export function NewJoinForm({ onBack, onCreated, showBackLink = true }: NewJoinFormProps) {
