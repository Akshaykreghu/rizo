...
export function DatePicker({
  ...
  function openPicker() {
    if (disabled) return;
    const base = selected ?? (maxV && toValue(todayYmd()) > toValue(maxV) ? maxV : minV && toValue(todayYmd()) < toValue(minV) ? minV : todayYmd());
        ...
        >
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <select
              ...
              aria-label="Month"
              className="flex-1 min-w-0 px-2 py-1 rounded-lg text-[13px] font-semibold text-[#0F172A] bg-slate-50 border border-transparent hover:border-slate-200 focus:outline-none focus:ring-2 focus:ring-[color:var(--color-primary)]/25 cursor-pointer"
            >
            ...
            <select
              ...
              aria-label="Year"
              className="w-[84px] px-2 py-1 rounded-lg text-[13px] font-semibold text-[#0F172A] bg-slate-50 border border-transparent hover:border-slate-200 focus:outline-none focus:ring-2 focus:ring-[color:var(--color-primary)]/25 cursor-pointer"
            >
          ...
          <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-100">
            <button
              ...
              className="px-2.5 py-1 rounded-lg text-[12px] font-semibold text-[color:var(--color-primary)] hover:bg-[color:var(--color-primary-light)] disabled:opacity-30 disabled:hover:bg-transparent"
            >
              Today
            </button>
            {!required && value && (
