...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Special Events Attendance', href: '/attendance/special-events', description: 'Override attendance for specific employees on a date.' },
      { label: 'Attendance Upload', href: '/attendance/upload', description: 'Bulk-upload punch times for multiple employees from a spreadsheet.' },
      { label: 'Exceptions', href: '/attendance/exceptions', description: 'Rule-based auto-regularization for late-in / early-out patterns.' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Leave Detailed Report', href: '/reports/leave-summary', description: 'View every leave request in a date range, with authorizer/approver detail.' },
      { label: 'Leave Balance Report', href: '/reports/leave-balance', description: 'View allotted, carry-forwarded, taken, and available leave balance per employee.' },
      { label: 'Monthly Leave Taken Register', href: '/reports/monthly-leave', description: 'View every approved leave date taken by an employee in a month.' },
      { label: 'Comp Off Details Report', href: '/reports/comp-off', description: 'View comp-off days accrued and utilized per employee.' },
